...
//    }
    ...
    public void setPinCode(String pincodeInfo) {
        pref = _context.getSharedPreferences(ApplicationConstants.PREFER_NAME,
                Context.MODE_PRIVATE);
        editor = pref.edit();
        editor.putBoolean(ApplicationConstants.IS_PINCODE_SET, true);
        editor.putString(ApplicationConstants.KEY_PINCODE_INFO, pincodeInfo);
        editor.commit();
    }

    public HashMap<String, String> getPincodeDetails() {
        pref = _context.getSharedPreferences(ApplicationConstants.PREFER_NAME,
                Context.MODE_PRIVATE);
        HashMap<String, String> user = new HashMap<String, String>();
        user.put(ApplicationConstants.KEY_PINCODE_INFO,
                pref.getString(ApplicationConstants.KEY_PINCODE_INFO, null));
        return user;
    }


    public boolean isPinCodeSet() {
        return pref.getBoolean(ApplicationConstants.IS_PINCODE_SET, false);
    }
