...
public class MyAddress_Activity extends Activity implements View.OnClickListener {
    ...
    private void init() {
        context = MyAddress_Activity.this;
    ...
    private void setUpToolbar() {
        ...
        mToolbar.setTitle(Html.fromHtml("<font color='#00000'>My Address</font>"));
